...
<div style={{ display: "grid",  gridTemplateColumns: window.innerWidth<891 ? "repeat(1, 10fr)" : "repeat(3, 10fr)", gridGap: 10 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "25% 25% 25% 25%", padding: "50px", width: "100%", height: "100%", maxHeight: "200px", overflow: "scroll" }}>
            {aliveTurtles.map(turtle => {
              return (<div key={turtle.name} style={{ padding: "5px" }}>
                <img src={turtle.image} alt={`turtle`} style={{cursor: "pointer"}} className="player_image" onClick={() => chosenTurtle(turtle)} />
              </div>);
            })}
          </div>}
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "25% 25% 25% 25%", padding: "50px", width: "100%", height: "100%", maxHeight: "200px", overflow: "scroll" }}>
            {deadItems.map(dead => {
              return (<div key={dead.name} style={{ padding: "5px" }}>
                <img src={dead.image} alt={`dead`} style={{cursor: "pointer"}} className="player_image" onClick={() => chosenDead(dead)}/>
              </div>);
            })}
          </div>}
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "25% 25% 25% 25%", padding: "50px", width: "100%", height: "100%", maxHeight: "200px", overflow: "scroll" }}>
            {aliveRabbits.map(rabbit => {
              return (<div key={rabbit.name} style={{ padding: "5px" }}>
                <img src={rabbit.image} alt={`rabbit`} style={{cursor: "pointer"}} className="player_image" onClick={() => chosenRabbit(rabbit)}/>
              </div>);
            })}
          </div>}
      </div>
      ...
      {isOpenTurtlePlayerCard && <div style={{ position: "absolute", bottom: 50, boxShadow: "0 0 25px black", borderRadius: "30px", left: "50%",top:"15%", transform: "translateX(-50%)", backgroundColor: "#eb4444", width: "350px", height: "400px", padding: "40px 25px 55px" }}>
            <div style={{ position: "relative", backgroundColor: "#fffeef", borderRadius: "50px", height: "100%", height: "350px", padding: "60px 20px 10px 20px" }}>
                ...
                <button className="exit-button-turtle" style={{ position: "absolute", bottom: "-20px", left: "50%", transform: "translateX(-50%)", padding: "10px 20px", fontSize: "20px", borderRadius: "10px", outline: "none", border: "none", color: "#fff", cursor: "pointer", letterSpacing:1.5, lineHeight: 1, fontFamily:"slapstick" }} onClick={() => setIsOpenTurtlePlayerCard(false)}>EXIT</button>
            </div>}
      ...
      {isOpenDeadPlayerCard && <div style={{ position: "absolute", bottom: 50, boxShadow: "0 0 25px black", borderRadius: "30px", left: "50%",top:"15%", transform: "translateX(-50%)", backgroundColor: "#b8baba", width: "350px", height: "400px", padding: "40px 25px 55px" }}>
            <div style={{ position: "relative", backgroundColor: "#fffeef", borderRadius: "50px", height: "100%", height: "350px", padding: "60px 20px 10px 20px"}}>
                ...
                <button className="exit-button-dead" style={{ position: "absolute", bottom: "-20px", left: "50%", transform: "translateX(-50%)", padding: "10px 20px", fontSize: "20px", borderRadius: "10px", outline: "none", border: "none", color: "#fff", cursor: "pointer", letterSpacing:1.5, lineHeight: 1, fontFamily:"slapstick" }} onClick={() => setIsOpenDeadPlayerCard(false)}>EXIT</button>
            </div>}
      ...
      {isOpenRabbitPlayerCard && <div style={{ position: "absolute", bottom: 50, boxShadow: "0 0 25px black", borderRadius: "30px", left: "50%",top:"15%", transform: "translateX(-50%)", backgroundColor: "#0184f9", width: "350px", height: "400px", padding: "40px 25px 55px" }}>
            <div style={{ position: "relative", backgroundColor: "#fffeef", borderRadius: "50px", height: "100%", height: "350px", padding: "60px 20px 10px 20px" }}>
                ...
                <button className="exit-button-rabbit" style={{ position: "absolute", bottom: "-20px", left: "50%", transform: "translateX(-50%)", padding: "10px 20px", fontSize: "20px", borderRadius: "10px", outline: "none", border: "none", color: "#fff", cursor: "pointer", letterSpacing:1.5, lineHeight: 1, fontFamily:"slapstick" }} onClick={() => setIsOpenRabbitPlayerCard(false)}>EXIT</button>
            </div>}
        ...
        {isOpenLeaderboard && <div style={{ position: "absolute", bottom: 105, boxShadow: "0 0 25px black", borderRadius: "30px", left: "50%", transform: "translateX(-50%)", backgroundColor: "#0184f9", width: "350px", height: "500px", padding: "50px 40px" }}>
